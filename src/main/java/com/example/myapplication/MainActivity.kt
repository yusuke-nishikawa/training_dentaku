...
class MainActivity : AppCompatActivity() {
    ...
    fun onClickBtn(view: View) {
        ...
        val result = resultView.text.toString() //今現在の計算結果を格納
...
//
        ...
        when(button.text){
            ...
            "=" -> {
                val resultCalc = calc.calculate(result)
                resultView.text = resultCalc.toString()
            }
            "±" -> {
...
//
//        //ボタンの宣言
////        val btnZero: Buttontton = findViewById(R.id.zero)
